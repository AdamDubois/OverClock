...
- `test_vitesse_IO.py` : Code de test pour mesurer la vitesse de lecture des données des ESP32 via I2C. Lit les données en permanence et affiche le temps de lecture dans la console. Utile pour vérifier que la communication I2C est suffisamment rapide pour les besoins du projet Bombe, notamment pour les énigmes qui nécessitent une lecture rapide des données des ESP32.